...
describe('WeatherService', () => {
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      ...
      providers: [
        WeatherService,
        { provide: ConfigService, useFactory: mockedUrl },
      ],
    }).compile();
    ...
    //This line is for now showing console.error in the tests
  ...
  describe('currentCity', () => {
    it('Should success from valid ip', async () => {
      ...
      jest
        ...
        .mockImplementationOnce(() => of(responseIpApi));
      ...
      jest
        .spyOn(httpService, 'get')
        .mockImplementationOnce(() => of(responseWeather));

      expect(await service.currentCity('24.48.0.1')).toEqual(
    ...
    it('Should success from valid city', async () => {
      ...
      jest
        .spyOn(httpService, 'get')
        .mockImplementation(() => of(responseWeather));

      expect(await service.currentCity('0:0:0:0', 'Montreal')).toEqual(
        responseWeather.data,
      );
    });
    ...
    it('Should give not found error', async () => {
      ...
      try {
        ...
        expect(error).toHaveProperty(
          'message',
          ConstantsApp.CITY_NOT_FOUND_ERROR,
        );
      }
    });
  ...
  describe('forecast', () => {
    ...
    it('Should success from valid city', async () => {
      ...
      jest
        .spyOn(httpService, 'get')
        .mockImplementation(() => of(responseWeather));
      expect(await service.forecast('', 'Montreal')).toEqual(
        responseWeather.data,
      );
    });
